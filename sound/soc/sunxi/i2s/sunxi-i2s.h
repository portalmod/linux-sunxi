...
/* IIS REGISTER */
#define SUNXI_IISBASE 		(0x01C22400) // Module Name in User Manual V1.2: DA0

#define SUNXI_IISCTL 	  	(0x00)	// Register Name in User Manual V1.2: DA_CTL - Digital Audio Control Register
...
#define SUNXI_IISFAT0 		(0x04)	// Register Name in User Manual V1.2: DA_FAT0 - Digital Audio Format Register 0
...
#define SUNXI_I2S_PLAYBACK_FORMATS (SNDRV_PCM_FMTBIT_S16_LE | SNDRV_PCM_FMTBIT_S24_LE | SNDRV_PCM_FMTBIT_S24_LE)
#define SUNXI_I2S_CAPTURE_FORMATS (SNDRV_PCM_FMTBIT_S16_LE | SNDRV_PCM_FMTBIT_S24_LE |SNDRV_PCM_FMTBIT_S24_LE)
